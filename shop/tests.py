...
class TestCategory(APITestCase):
    # On stocke l'url dans un attribut de classe pour pouvoir l'utiliser facilement lors de nos tests
    url = reverse_lazy('category-list')

    def format_datetime(self, value):
        # Cette méthode aide à formater une date en chaine de caractère sous le même format que celui de l'api
    ...
    def test_list(self):
        ...
        # On rélise l'appel en GET en utilisant le client de la classe de test
    ...
    def test_create(self):
        ...
        # Enfin, on vérifie qu'aucune nouvelle catégorie n'a été créée malgré le status code 405
        self.assertFalse(Category.objects.exists())
